  ...
  return (
    <header
      className={`fixed top-0 w-full z-50 transition-all duration-500 ${
        isScrolled
          ? "glass-header border-b border-cyan-500/30 shadow-2xl shadow-cyan-500/20"
          : "bg-transparent"
      }`}
    >
      <nav className="container-max">
        <div className="flex justify-between items-center py-5 px-6">
          <Link
            href="/"
            className="text-3xl font-black gradient-text hover:scale-110 transition-transform duration-500"
          >
            DP.
          </Link>
